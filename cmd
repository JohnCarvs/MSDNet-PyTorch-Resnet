...
python main_inference_imagenetc_bayes_voting_3.py --data-root data/imagenet --data ImageNet --save save --arch msdnet --batch-size 4096 --epochs 90 --nBlocks 5 --stepmode even --step 4 --base 4 --nChannels 32 --growthRate 16 --grFactor 1-2-4-4 --bnFactor 1-2-4-4 --evalmode dynamic --evaluate-from ./save/save_models/msdnet-step=4-block=5.pth.tar --use-valid --gpu 3 -j 64 