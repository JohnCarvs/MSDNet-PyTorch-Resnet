...
def validate_ensemble(val_loader, model, criterion):
    batch_time = AverageMeter()
    losses = AverageMeter()
    data_time = AverageMeter()
    top1, top5 = [], []
...
def validate_with_bayes_matrix(val_loader, model, criterion, bayes_matrix):
    # 使用贝叶斯矩阵进行迭代概率更新
    batch_time = AverageMeter()
    losses = AverageMeter()
    data_time = AverageMeter()
...
def validate_with_bayes_matrix_conformal_prediction(val_loader, model, criterion, bayes_matrix, threshold):
    # 使用贝叶斯矩阵进行迭代概率更新
